...
#define MOSI	 	PAout(7)
/*********************************** RC522 函数宏定义*********************************************/
#define         RC522_CS_Enable()         HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_RESET)
#define         RC522_CS_Disable()        HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_SET)

#define         RC522_Reset_Enable()      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_6,GPIO_PIN_RESET)
#define         RC522_Reset_Disable()     HAL_GPIO_WritePin(GPIOE,GPIO_PIN_6,GPIO_PIN_SET)
...
#define         RC522_MOSI_1()            HAL_GPIO_WritePin(GPIOB,GPIO_PIN_15,GPIO_PIN_SET)
